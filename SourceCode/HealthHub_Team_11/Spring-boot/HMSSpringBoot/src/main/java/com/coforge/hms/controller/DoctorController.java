...
public class DoctorController {
    ...
    @GetMapping(value = "/doctor/name/{name}", produces = { MediaType.APPLICATION_JSON_VALUE,
		MediaType.APPLICATION_XML_VALUE })
public ResponseEntity<DoctorDTO> findByName(@PathVariable String name) throws Exception {

	DoctorDTO doc = docService.getByName(name);
	return ResponseEntity.ok().body(doc);
}
